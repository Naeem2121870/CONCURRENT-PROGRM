...
/**
 * This version of exercise 3 is unsynchronized and suffers from the problem of
 * lost updates. The effect of the lost updates can be noted from the shrinking
 * total displayed by the test() method. Note that the application finally
 * deadlocks as all Transactions threads sleep.
 */
